...
//		this.tvgRep.save(new Tvg("CityCenter", "Marjane", (new SimpleDateFormat("YYYY-MM-DD").parse("2005-03-31")), "Meknès", "Morocco", "Fès-Meknès", "Citycenter@gmail.com", "05xxxxxxxx", "08:00", "12:00", "14:00", "18:00", true, null, null, accountRep.findOne((long) 2)));
...
//		this.vehicleRep.save(new Vehicle("Peaugot", "Car (Light vehicles)", (new SimpleDateFormat("YYYY-MM-DD").parse("2015-01-01")), "RegistrationX", motoristRep.findOne((long) 1)));
//		this.vehicleRep.save(new Vehicle("Reanult", "Car (Light vehicles)", (new SimpleDateFormat("YYYY-MM-DD").parse("2015-10-10")), "RegistrationY", motoristRep.findOne((long) 1)));
